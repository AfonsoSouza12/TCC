...
INSERT INTO solicitacao(nome,descricao,data_inicio,data_fim,status,etapa_id,projeto_id,usuario_id,sprint_id) VALUES ('Solicitação 2','blablabla2', null,null,'To Do',1,1,1)
INSERT INTO solicitacao(nome,descricao,data_inicio,data_fim,status,etapa_id,projeto_id,usuario_id,sprint_id) VALUES ('Solicitação 3','blablabla3', null,null,'Doing',1,2,1)
INSERT INTO solicitacao(nome,descricao,data_inicio,data_fim,status,etapa_id,projeto_id,usuario_id,sprint_id) VALUES ('Solicitação 4','blablabla4', null,null,'Test',1,2,1)
INSERT INTO solicitacao(nome,descricao,data_inicio,data_fim,status,etapa_id,projeto_id,usuario_id,sprint_id) VALUES ('Solicitação 5','blablabla5', null,null,'Done',1,2,1)